...
ssl_age <- ssl %>% 
  #using forcats:fct_relevel to re-order levels to desired order in key
  ...
  geom_density(stat = "bin") +
   labs(title = "SSL List Subjects by Current Age", 
             x = "SSL Score",  
             y = "Density",
             color = "Age Group", 
             caption = "(Source: Chicago Data Portal)") +
...
Highest scores are for age group less than 20! Interesting. Also wondering what this extra pink lump is. 

OK now let's turn to race. 
